...
class AdminController extends Controller
{
    ...
    public function invoice_submit(request $request){
        ...
        ->join('category','invoice_details.product_id','products.id')
        ->select('invoice_details.*','products.cat_id','products.name')
        ...
        // $tex = $request->tex;
        return view('admin.product.pdfview_download',compact('client','invoiceData','InvoiceDetails'));
