...
class AdminController extends Controller
{
    ...
    public function invoice_submit(request $request){
        ...
        $InvoiceDetails   = InvoiceDetails::where('invoice_data_id',$invoiceData->id)->get();
        ...
        $pdf = PDF::loadView('admin.product.pdfview_download',compact('invoiceData','InvoiceDetails','tex','client','product','sub_total','tax_amount','total_amount'));
        // $pdf = PDF::loadView('admin.product.pdfview_download');
        // return $pdf;
        return $pdf->download('pdfview.pdf');
    }
