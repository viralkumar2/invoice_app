              ...
              <form action='{{ route('setting.update',$data->id) }}' method='POST' enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name='company_phone' placeholder="Company Phone" value='{{ $data->company_name }}'>
                      @error('company_phone')
                            <P class='text-danger'>{{ $message }}</P>
                      @enderror
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name='company_mobile' placeholder="Company Mobile" value='{{ $data->company_name }}'>
