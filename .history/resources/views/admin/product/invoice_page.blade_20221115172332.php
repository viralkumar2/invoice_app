        ...
        var products = {!! $product->toJson() !!};
         $("#dynamic-ar").click(function() {
            ...
            $("#tab_logic").append('<tr><td><select onchange=product_chnage(' + x +
                ...
                ' name="attraction_or_activity[]"><option value=''>Select Product</option></select></td><td><input type="text" class="form-control add_category" readonly id="add_category' +
                x +
            ...
            var last_product = $('#product_1'+x+' option:selected').last().val();
