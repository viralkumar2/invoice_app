               ...
               <div class="col-12 table-responsive">
                  <form action="{{ url('store-input-fields') }}" method="POST">
                     ...
                     <table class="table table-bordered" id="dynamicAddRemove">
                         ...
                         <tr>
                             <td>
                              <select class="form-control product"name="attraction_or_activity[]" id="product1" onchange='product_chnage()'>
                             ...
                             <td><input type="text" class="form-control add_category" id="add_categoryq"/></td>
