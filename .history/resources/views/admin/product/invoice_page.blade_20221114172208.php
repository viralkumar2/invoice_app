                        ...
                        <td colspan="4">
                           <table>
                              <tr class='add_clients'>
                                 ...
                                 <td class='td text-address_hide' id='address_hide'  style="display:none;">
                                    viral - kumar<br>+9574535297<br>vk@gmail.com
                                 </td>
                                 
                                 <td class='text-address_hide_option'>
                                    <select class="form-control" name="clients" id="clients">
                                       <option >Select Product</option>
                                       @foreach ($product as $row)
                                         <option value="{{ $row->id }}" frist_name='{{ $row->name }}'>{{ $row->name }}</option>
                                       @endforeach
                                   </select>
                                 </td>
  ...
  function calculateTotals() {
    ...
    return `$${Number(amount).toFixed(2)}`;
      ...
      $("#clients").change(function(){
            ...
            $('#setMyTag').val(myTag);
            $('.address_hide').show();
            $('.address_hide_option').hide('d-none');
            // $('.add_clients').html('viral')
            address_hide
        });
