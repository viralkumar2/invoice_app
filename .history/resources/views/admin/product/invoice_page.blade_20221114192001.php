                    ...
                    <div class="col-12">
                        <div class="invoice-box">
                            <table cellpadding="0" cellspacing="0">
                                        ...
                                        <select class="form-control product" name="product" id="product"
                                            ...
                                            @foreach ($product as $row)
                                                <option value="{{ $row->id }}" pro_id='{{ $row->id }}'
                                                    cat_name='{{ $row->cat_name }}' pro_prices='{{ $row->rate }}'>
                                                    {{ $row->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <button class="btn btn-primary btn-add-row disabled">Add row</button>
                                    </td>
                                </tr>
                                <tr class="total">
                                    <td colspan="3"></td>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#clients").change(function() {
                ...
                $('#address_hide').html('' + first_name + '- ' + last_name + '<br>' + email + '<br>' +
                    phone + '');
            ...
            $('.btn-add-row').on('click', () => {
                ...
                $('.item').append(
                    '<tr class="item"><td><select class="form-control product" name="product" id="product" onchange="product_chnage()"><option>Select Product</option><option value="22" pro_id="22" cat_name="Kaye Prince" pro_prices="20">Ivor Wolfe</option><option value="24" pro_id="24" cat_name="Rhonda Hewitt" pro_prices="38">Yoko Hewitt</option></select></td><td><input type="text" class="form-control add_category add_category21 add_category23" id="add_category"></td><td><input type="number" readonly="" class="form-control add_price add_price21 add_price23" id="add_price"></td><td><input type="number" class="form-control" value="1"></td><td>0.00</td></tr>'
                    )
