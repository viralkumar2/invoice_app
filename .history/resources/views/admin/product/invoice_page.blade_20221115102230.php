      ...
      $("#dynamic-ar").click(function () {
        ++i;
         $("#dynamicAddRemove").append('<tr><td><input type="text" name="addMoreInputFields[' + i +
            '][subject]" placeholder="Enter subject" class="form-control" /></td><td><input type="text" class="form-control add_category" id="add_category"/></td><td><input type="number" readonly class="form-control add_price" id='add_price'/></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>'
         );
      });
