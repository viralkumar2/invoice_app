                  ...
                  <form action="{{ url('store-input-fields') }}" method="POST">
                     ...
                     <table class="table table-bordered" id="tab_logic" >
                         ...
                         <tr class='item'>
                             ...
                             <td><input type="number" readonly class="form-control price add_price" id='add_price1'/></td>
                             <td><input type="number" class="form-control qty" value="1"/></td>
                             {{-- <td><input type="number" class="form-control" value="1"/></td> --}}
                             <td >
                              {{-- <span id='item_sub_total1' class='total' readonly>0.00</span> --}}
    ...
    var i = 0;
      ...
      var products = {!! $product->toJson() !!};
         $("#dynamic-ar").click(function () {
               ...
               $("#tab_logic").append('<tr><td><select onchange=product_chnage('+x+') class="text-two form-control product item_select" id=product_'+x+' data-id='+x+' name="attraction_or_activity"><option >Select Product</option></select></td><td><input type="text" class="form-control add_category" readonly id="add_category'+x+'"/></td><td><input type="number" readonly class="form-control price add_price" id="add_price'+x+'"/></td><td><input type="number" class="form-control qty" value="1"/></td><td><input type="number" name=total[] placeholder='0.00' class="form-control total" readonly/></td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>'
               );
