...
<script type="text/javascript">
    ...
    var $wrapper = $('.multi-fields', this);
      ...
      $.each(products, function( index, value ) {
         console.log( index + ": " + value['cat_name'] );
            $('.select_items').append('<td><select class="text-two select_items'+x+'" name="attraction_or_activity[]"></select></td><option value='+value['id']+'>'+value['cat_name']+'</option>');
      });

      // <select class="text-two'+x+'" name="attraction_or_activity[]"><option value="activity">Activity</option></select>
      $("#dynamic-ar").click(function () {
        ++i;
        x++;
         $("#dynamicAddRemove").append('<tr><td><select class="text-two select_items'+x+'" name="attraction_or_activity[]"></select></td><td><input type="text" class="form-control add_category" id="add_category"/></td><td><input type="number" readonly class="form-control add_price" id=add_price/></td><td><input type="number" class="form-control" value="1"/></td><td><input type="number" class="form-control" value="1"/></td><td>1.1</td><td><button type="button" class="btn btn-outline-danger remove-input-field">Delete</button></td></tr>'
         );
      });
