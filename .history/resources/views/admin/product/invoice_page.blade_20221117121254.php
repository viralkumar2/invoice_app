                        ...
                        <div class="invoice p-3 mb-3">
                              ...
                              <div class="row justify-content-between">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <h4> <img class='rounded-circle'src="{{ asset('all_image/'.$setting->logo) }}"width="80" height="80" alt=""></h4>
                                 </div>
                                 ...
                                 <table class="table table-bordered table_total">
                                    <tbody>
                                            ...
                                            <td class="text-center">
                                                <div class="input-group mb-2 mb-sm-0">
                                                    <input type="number" readonly class="form-control" id="disscount"
                                                        placeholder="0" name='tex' value='{{ $setting->disscount }}'>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input type="hidden" name='Discount_amount'
      ...
      $("#clients").change(function(){
        ...
        function calc() {
         ...
         function calc_total() {
            ...
            $('#Discount_amount').val(disscount_sum.toFixed(2));
