  ...
  $(document).ready( function () {
   ...
   $("#clients").change(function(){
    ...
    $('.btn-add-row').on('click', () => {
         ...
         const $newRow = $lastRow.append('<tr class="item"><td><select class="form-control product" name="product" id="product" onchange="product_chnage()"><option>Select Product</option>
                        
                          
                              
                                                              
                                                              <option value="22" pro_id="22" cat_name="Kaye Prince" pro_prices="20">Ivor Wolfe</option>
                                                              
                                                              <option value="24" pro_id="24" cat_name="Rhonda Hewitt" pro_prices="38">Yoko Hewitt</option>
                                                        </select>
                          
                        </td>
                        <td><input type="text" class="form-control add_category add_category21 add_category23" id="add_category"></td>
                        <td><input type="number" readonly="" class="form-control add_price add_price21 add_price23" id="add_price"></td>
                        <td><input type="number" class="form-control" value="1"></td>
