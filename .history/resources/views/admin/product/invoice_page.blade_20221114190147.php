                        ...
                        <td>
                          <select class="form-control product" name="product" id="product" onchange='product_chnage()'>
                              ...
                              @foreach ($product as $row)
                                <option value="{{ $row->id }}" pro_id='{{ $row->id }}' cat_name='{{ $row->cat_name }}' pro_prices='{{ $row->cat_name }}'>{{ $row->name }}</option>
                              @endforeach
                          </select>
                          
                        </td>
                        <td><input type="text" class="form-control add_category" id="add_category"/></td>
                        <td><input type="number" class="form-control add_price" id='add_price'/></td>
...
function product_chnage(){
         ...
         var price = $('.product option:selected').last().attr('pro_id');
         $('.'+add_price_value).val(cat_name);
