    ...
    var $wrapper = $('.multi-fields', this);
      ...
      $.each(products, function( index, value ) {
         console.log( index + ": " + value['cat_name'] );
            select_item = '<option value='+value['id']+'>'+value['cat_name']+'</option>';
      });
