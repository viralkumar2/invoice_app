...
table#tab_logic {
    ...
    $(document).ready(function() {
      ...
      $("#clients").change(function(){
        ...
        var products_check = {!! $product->toJson() !!};
         $("#dynamic-ar").click(function() {
//             // for (let i = 1; i <= x; i++) {
//             //    var last_product = $('#product_'+i+' option:selected').val();
//                // var selectedItem_1 = $('#product_' + i + ':last').find(":selected").val();
//                selectedItem_1.push($('#product_' + i + ':last').find(":selected").val());
//             // }
//             // console.log(x);
//             // console.log(selectedItem_1);
//             console.log(products_check);
//             var common = $.grep(products_check, function(element) {
//                return $.inArray(element, selectedItem_1) !== -1;
//             });

// console.log(common); // ["a", "c", "d", "e"]

//             console.log(difference([$selectedItem_1, $products_check]));
            // $.each(selectedItem_1, function(index, value) {

               

            //       $.each(products_check, function(index_p, p_value) {
            //          if(value != p_value['id']){
            ...
            // var select = $('.product select[name="attraction_or_activity"]').val();
