             ...
             <div class="row">
               <div class="col-12 table-responsive">
                  <form action="{{ url('store-input-fields') }}" method="POST">
                     ...
                     @endif
                     {{-- id="dynamicAddRemove" --}}
                     <table class="table table-bordered" id="tab_logic"  class='tab_logic'>
                         <tr>
                            <td>Product</td>
                            <td>Category</td>
                            <td>Rate</td>
