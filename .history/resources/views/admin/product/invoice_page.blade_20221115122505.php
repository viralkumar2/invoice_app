                     ...
                     <table class="table table-bordered" id="dynamicAddRemove">
                         ...
                         <tr>
                             <td>
                              ...
                              <select class="form-control product"name="attraction_or_activity[]" id="product_1" data-id='1'>
...
<script type="text/javascript">
   ...
   //  var $wrapper = $('.multi-fields', this);
         ...
         $("#dynamic-ar").click(function () {
               ...
               $.each(products, function( index, value ) {
                  ...
                  // if(selectedItem_1 != value['id']){
                     $('#product_'+x+'').append('<option value='+value['id']+'>'+value['name']+'</option>');
                  // }
                  // else{
      ...
      $("select").on("change", function() {
         ...
         $('add_category1'+addclass_value).val(cat_name);
