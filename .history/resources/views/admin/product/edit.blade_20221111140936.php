              ...
              <form action='{{ route('product.store') }}' method='POST' enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="sr_no" name='sr_no'placeholder="Enter Product Serial No" value='{{ $data->sr_no }}'>
                        @error('sr_no')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="Amount" name='amount' placeholder="Enter Product amount" value='{{ $data->amount }}'>
                        @error('amount')
                            <P class='text-danger'>{{ $message }}</P>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="Tax" name='tax' placeholder="Enter Product tax" value='{{ $data->tax }}'>
                        @error('tax')
                            <P class='text-danger'>{{ $message }}</P>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="Tax">Tax</label>
                        <img src="{{ asset('all_image/'.$data->image) }}" class="form-control" width="90" height="90" alt="">
