                        ...
                        <td>
                          <select class="form-control product" name="product" id="product" onchange='product_chnage()'>
                              ...
                              @foreach ($product as $row)
                                <option value="{{ $row->id }}" pro_id='{{ $row->id }}' cat_name='{{ $row->cat_name }}'>{{ $row->name }}</option>
                              @endforeach
                          </select>
                          
                        </td>
                        <td><input type="text" class="form-control add_category"/></td>
...
function product_chnage(){
         ...
         var element = $('#service_id option:selected').last().val();
         // var element = $('.product option:selected').val();
         // $('.add_category').addClass('add_category'+element);

         var addclass_value = 'add_category'+element;
         var cat_name = $('option:selected', this).attr('cat_name');
