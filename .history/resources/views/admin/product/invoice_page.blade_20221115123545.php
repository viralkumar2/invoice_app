         ...
         $("#dynamic-ar").click(function () {
               ...
               $.each(products, function( index, value ) {
                  ...
                  // if(selectedItem_1 != value['id']){
                     // pro_id='{{ $row->id }}' cat_name='{{ $row->cat_name }}' pro_prices='{{ $row->rate }}
                     $('#product_'+x+'').append('<option value='+value['id']+' pro_id='+value['id']+' cat_name=['+value['cat_name']+'] pro_prices=['+rate+'] >'+value['name']+'</option>');
                  // }
                  // else{
